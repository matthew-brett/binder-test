...
Notebook text can have formatting, such as links. For example, this
sentence ends with a link to the earlier [second edition of this
...
At this stage we start to feel that we are doing to much typing. Notice
...
to type, the more chance we have to make a mistake.
...
Notice that `alex_meal` has a new value now. It was 10.50, but now it is
7.75. We have *reset* the value of `alex_meal`. Now we have done this,
we can *recalculate* the bill before tip with *exactly the same code as
before*:
